...
```
$ docker image tag invoice efrengarcial/invoice
$ docker push efrengarcial/invoice
$ docker image tag notification efrengarcial/notification
$ docker push efrengarcial/notification
$ docker image tag store efrengarcial/store
$ docker push efrengarcial/store
```
